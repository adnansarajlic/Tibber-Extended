...
- **Konfigurerbara Måltimmar**: Bestäm helt själv i integrationens _Configure_-dialog om "billigast period" innebär 1, 2, 3 eller upp till 6 timmar (Standard är nu 3 timmar för både billigast och dyrast).
